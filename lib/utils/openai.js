...
- run_command: {"command": "commande shell", "cwd": ".", "timeout": 5000} - Exécuter une commande système (timeout optionnel en ms pour serveurs)
</available_actions>
...
RÉPONDS UNIQUEMENT EN JSON VALIDE - PAS DE MARKDOWN, PAS DE BACKTICKS:
{
  ...
  try {
    ...
    // Afficher les informations sur les tokens pour generateActionPlan
    if (response.usage) {
